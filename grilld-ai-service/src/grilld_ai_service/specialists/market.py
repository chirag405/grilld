...
MARKET_ANALYST = {
    ...
    "system_prompt": f"""You are Grilld's Market Analyst. Read the project brief (check the \
...
not a VC-deck market sizing exercise.
...
COMPETITION_ANALYST = {
    ...
    "system_prompt": f"""You are Grilld's Competition Analyst. Read the project brief and \
...
STRATEGY_AGENT = {
    ...
    "system_prompt": f"""You are Grilld's Strategy Agent. Read the project brief, \
