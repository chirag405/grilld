...
function DropdownMenuSubTriggerPrimitive({
  ...
  return (
    <DropdownMenuPrime.SubTrigger asChild ref={highlightedRef} disabled={disabled} textValue={textValue}>
...
function DropdownMenuContentPrimitive({
  ...
  return (
    <AnimatePresence>
      {isOpen && (
        <DropdownMenuPortalPrimitive forceMount container={container}>
          <DropdownMenuPrime.Content asChild loop={loop} onCloseAutoFocus={onCloseAutoFocus} onEscapeKeyDown={onEscapeKeyDown} onPointerDownOutside={onPointerDownOutside} onFocusOutside={onFocusOutside} onInteractOutside={onInteractOutside} side={side} sideOffset={sideOffset} align={align} alignOffset={alignOffset} avoidCollisions={avoidCollisions} collisionBoundary={collisionBoundary} collisionPadding={collisionPadding} arrowPadding={arrowPadding} sticky={sticky} hideWhenDetached={hideWhenDetached}>
...
function DropdownMenuItemPrimitive({
  ...
  return (
    <DropdownMenuPrime.Item asChild ref={highlightedRef} disabled={disabled} onSelect={onSelect} textValue={textValue}>
...
function DropdownMenuCheckboxItemPrimitive({
  ...
  return (
    <DropdownMenuPrime.CheckboxItem asChild ref={highlightedRef} checked={checked} onCheckedChange={onCheckedChange} disabled={disabled} onSelect={onSelect} textValue={textValue}>
...
function DropdownMenuRadioItemPrimitive({
  ...
  return (
    <DropdownMenuPrime.RadioItem asChild ref={highlightedRef} value={value} disabled={disabled} onSelect={onSelect} textValue={textValue}>
...
function DropdownMenuItemIndicatorPrimitive(props: DropdownMenuItemIndicatorPrimitiveProps) {
  return (
    <DropdownMenuPrime.ItemIndicator asChild>
      <motion.div data-slot="dropdown-menu-item-indicator" {...props} />
