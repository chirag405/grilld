...
function DialogOverlayPrimitive({
  ...
  return (
    <DialogPrime.Overlay data-slot="dialog-overlay" forceMount asChild>
      <motion.div key="dialog-overlay" initial={{ opacity: 0, filter: 'blur(4px)' }} animate={{ opacity: 1, filter: 'blur(0px)' }} exit={{ opacity: 0, filter: 'blur(4px)' }} transition={transition} {...props} />
    </DialogPrime.Overlay>
  );
}
...
function DialogContentPrimitive({
  ...
  return (
    <DialogPrime.Content forceMount onOpenAutoFocus={onOpenAutoFocus} onCloseAutoFocus={onCloseAutoFocus} onEscapeKeyDown={onEscapeKeyDown} onPointerDownOutside={onPointerDownOutside} onInteractOutside={onInteractOutside} asChild>
      <motion.div key="dialog-content" data-slot="dialog-content" initial={{
                opacity: 0,
                filter: 'blur(4px)',
